...
/// Command for updating a project directly
struct UpdateCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "update",
        abstract: "Update a project (pull latest changes)"
    )

    @Argument(help: "Project name to update")
    ...
    func run() async throws {
        ...
        do {
            ...
            let result = try await operationController.executeOperation(.update, on: project)
